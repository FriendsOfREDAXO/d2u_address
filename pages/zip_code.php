...
if (1 === (int) filter_input(INPUT_POST, 'btn_save') || 1 === (int) filter_input(INPUT_POST, 'btn_apply')) {
    ...
    $zipcode = new D2U_Address\ZipCode($form['zipcode_id'], (int) rex_config::get('d2u_helper', 'default_lang'));
    $zipcode->range_from = $form['range_from'];
    $zipcode->range_to = $form['range_to'];
    $zipcode->country = new D2U_Address\Country($form['country_id'], (int) rex_config::get('d2u_helper', 'default_lang'));
...
if (1 === (int) filter_input(INPUT_POST, 'btn_delete', FILTER_VALIDATE_INT) || 'delete' === $func) {
    ...
    $zipcode = new D2U_Address\ZipCode($zipcode_id, (int) rex_config::get('d2u_helper', 'default_lang'));
    $zipcode->delete();
				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            ...
                            $zipcode = new D2U_Address\ZipCode($entry_id, (int) rex_config::get('d2u_helper', 'default_lang'));
                            $readonly = true;
