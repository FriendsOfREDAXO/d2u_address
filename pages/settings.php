...
<form action="<?php print rex_url::currentBackendPage(); ?>" method="post">
	<div class="panel panel-edit">
		...
		<div class="panel-body">
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
						...
						d2u_addon_backend_helper::form_select('d2u_address_default_country_id', 'settings[default_country_id]', $country_options, [intval(rex_config::get('d2u_address', 'default_country_id'))]);
					?>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
						d2u_addon_backend_helper::form_checkbox('d2u_helper_lang_wildcard_overwrite', 'settings[lang_wildcard_overwrite]', 'true', rex_config::get('d2u_address', 'lang_wildcard_overwrite') === 'true');
						foreach(rex_clang::getAll() as $rex_clang) {
							...
							foreach($replacement_options as $key => $value) {
								$selected = $value === strval(rex_config::get('d2u_address', 'lang_replacement_'. $rex_clang->getId())) ? ' selected="selected"' : '';
			...
			<fieldset>
				<legend><small><i class="rex-icon fa-google"></i></small> <?php echo rex_i18n::msg('d2u_address_settings_analytics'); ?></legend>
				<div class="panel-body-wrapper slide">
					<?php
						d2u_addon_backend_helper::form_checkbox('d2u_address_settings_analytics_emailevent_activate', 'settings[analytics_emailevent_activate]', 'true', rex_config::get('d2u_address', 'analytics_emailevent_activate') === 'true');
						d2u_addon_backend_helper::form_input('d2u_address_settings_analytics_emailevent_category', 'settings[analytics_emailevent_category]', strval(rex_config::get('d2u_address', 'analytics_emailevent_category')), false, false, 'text');
						d2u_addon_backend_helper::form_input('d2u_address_settings_analytics_emailevent_action', 'settings[analytics_emailevent_action]', strval(rex_config::get('d2u_address', 'analytics_emailevent_action')), false, false, 'text');
					?>
					<script>
						function changeType() {
